function initCanvas(){
    ...
    backgroundImage.src = "img/subackground.png";
    naveImage.src       = "img/spacecraft.png";
    enemiespic1.src     = "img/enemy_1.png";
    enemiespic2.src     = "img/enemy_2.png";
    ...
    function Launcher(){
        ...
        this.misiles = [];
         ...
         this.gameStatus = {
            ...
            message: "",
            fillStyle: 'red',
            font: 'italic bold Arial 36px, sans-serif',
        }
